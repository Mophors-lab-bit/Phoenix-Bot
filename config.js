...
//____________________________________________________________________________________________________________________________________________  
  SESSION_ID: process.env.SESSION_ID || 'Phoenix~EagleZephyr',
  ...
  SUDO: process.env.SUDO || '9027933188',
  ...
  AUTO_STATUS_REPLY_MSG: process.env.AUTO_STATUS_REPLY_MSG || 'false',
  AUTO_STATUS_REACT: toBool(process.env.AUTO_STATUS_REACT || 'false'),
  AUTO_STATUS_REACT_EMOJI: process.env.AUTO_STATUS_REACT_EMOJI || 'false',
